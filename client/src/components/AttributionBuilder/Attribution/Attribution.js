...
export default class Attribution extends React.Component {
  ...
  render() {
    return (
      <div
        id={`attribution.${this.props.attribution.index}`}
        className={s.compact}
      >
        <Table className={s.compacttable}>
          <tbody>
                  ...
                  <tbody>
                    <tr>
                      ...
                      {this.props.extraLabel && (
                        <td className={s.row}>{this.props.extraLabel}</td>
                      )}
                      <td className={s.row}>
                        <Button
                          id="removeButton"
            ...
            <tr>
              ...
              {this.props.extraField && <td>{this.props.extraField}</td>}
            </tr>
