...
module.exports = {
  config: {
    ...
    admin_api_url:
      getEnv("ADMIN_API_URL") || "admin-api.phylogenyexplorerproject.com",
    public_api_url:
      getEnv("PUBLIC_API_URL") || "public-api.phylogenyexplorerproject.com",
    sender_email:
      getEnv("AWS_SENDER_EMAIL") || "contact@phylogenyexplorerproject.com",
  ...
  auth: {
    ...
    facebook: {
      ...
      secret:
        getEnv("FACEBOOK_APP_SECRET") || "a970ae3240ab4b9b8aae0f9f0661c6fc"
    },
